...
public class AdvancedSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advanced_select);
    ...
    protected void onResume() {
        ...
        int topicReached = Progression.getInstance(this).getProgression("advanced");
        //Toast.makeText(getApplicationContext(), "progression/advanced is: "+topicReached, Toast.LENGTH_SHORT).show();
        ...
        for(int i = 0; i < topics.length; i++)
        {
            ...
            Log.d("ADVANCED", "advanced/content/" + topics[i]);
            l.setOnClickListener(getListener("advanced/content/" + topics[i]));
            b.setOnClickListener(getListener("advanced/content/" + topics[i]));
